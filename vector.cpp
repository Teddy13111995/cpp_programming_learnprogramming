...
void test5()
{
    ...
    std::cout << "Front " << stooges.front() << " and back " << stooges.back() << std::endl;
...
{
    /*
    std::back_inserter is a back-iterator that inserts new elements at the end of the container.
    there is also a front_inserter we can use with deques and lists
    copy one list to another using an ierator and back inserter
    */
    std::cout << "\nTest9==============================" << std::endl;
    std::vector<int> vec1{1, 2, 3, 4, 5};

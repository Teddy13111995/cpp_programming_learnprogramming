...
//for displaying the array the size MUST be included when passing a std::array to a function
...
void test1(){
    ...
    std::cout<<arr1.size()<<" "<<arr2.size()<<" are the size of two arrays"<<std::endl;
...
void test7(){
    ...
    std::cout<<"sum of elements of arr1 "<<sum<<std::endl;

}

void test8(){
    std::cout<<"\nTest8=============================="<<std::endl;
    std::array<int,5> arr1{1,2,1,4,1};
    int count=std::count(arr1.begin(),arr1.end(),1);
    std::cout<<"Found 1: "<<count<<" times"<<std::endl;
